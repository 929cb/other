...
#include "../bsp/ft5426/bsp_ft5426.h"
#include <stdio.h>
...
void decimals_display(unsigned short x, unsigned short y, unsigned char size, signed int num)
{
	...
	if(num < 0)
		...
		sprintf(buf, "%d.%d", integ, fract);
	lcd_fill(x, y, x + 40, y + size, tftlcd_dev.backcolor);
	lcd_show_string(x, y, 40, size, size, buf); 
}
...
int main(void)
{
	...
	{		
		...
		decimals_display(50 + 70 + 70, 130, 16, icm20608_dev.accel_x_act);
		decimals_display(50 + 70 + 70, 150, 16, icm20608_dev.accel_y_act);
		decimals_display(50 + 70 + 70, 170, 16, icm20608_dev.accel_z_act);
		decimals_display(50 + 70 + 70, 190, 16, icm20608_dev.gyro_x_act);
		decimals_display(50 + 70 + 70, 210, 16, icm20608_dev.gyro_y_act);
		decimals_display(50 + 70 + 70, 230, 16, icm20608_dev.gyro_z_act);
		decimals_display(50 + 70 + 70, 250, 16, icm20608_dev.temp_act);
